...
@section('content')
    <!-- Card Section -->
    <div class="bg-white rounded-xl shadow dark:bg-slate-900 | max-w-4xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <form>
            <!-- Card -->
            <div class="flex gap-32 justify-stretch">
                <div class=" space-y-2">
                ...
                <div class=" pt-0 p-4 sm:pt-0 sm:p-7">
                    ...
                    <div class="space-y-4 sm:space-y-6">
                        ...
                        <div class="space-y-2">
                            <label for="af-submit-app-deskripsi"
                                class="inline-block text-sm font-medium text-gray-800 mt-2.5 dark:text-gray-200">
                                Deskripsi
                            </label>

                            <textarea id="af-submit-app-deskripsi"
                                class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                                rows="6"
                                placeholder="Masukan deskripsi kegiatan"></textarea>
                        </div>
                    </div>
                    <!-- End Grid -->
