  ...
  @endif
    ...
    <div class="flex-1 flex justify-center items-center ml-64 mb-62">
        <div class="overflow-x-auto">
            <form method="POST" action="/admin/activities/store" enctype="multipart/form-data" style="background-color: #e9e9e9; color: black;" class="p-20">
                @csrf 
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-control w-full">
                        ...
                        <input type="text" placeholder="Location" class="input input-bordered w-full" name="location" >
                        @error('location')
                            <div class="label">
                                <span class="label-text-alt text-error">{{ $message }}</span>
                            </div>
                    ...
                    <div class="form-control w-full">
                        ...
                        <input type="text" placeholder="Location Link" class="input input-bordered w-full" name="location_link">
                        @error('location_link')
                            <div class="label">
                                <span class="label-text-alt text-error">{{ $message }}</span>
                            </div>
                    ...
                    <div class="form-control w-full">
                        ...
                        <input type="date" placeholder="Activity Date" class="input input-bordered w-full" name="activity_date">
                        @error('activity_date')
                            <div class="label">
                                <span class="label-text-alt text-error">{{ $message }}</span>
                            </div>
                    ...
                    <div class="form-control w-full">
                        ...
                        <input type="file" placeholder="Image" class="input input-bordered w-full p-2" name="image">
                        @error('image')
                            <div class="label">
                                <span class="label-text-alt text-error">{{ $message }}</span>
                            </div>
