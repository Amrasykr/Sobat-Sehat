  ...
  @endif
    ...
    <div class="flex-1 flex justify-center items-center ml-64 mb-62">
        <div class="overflow-x-auto">
            <form method="POST" action="/admin/activities/update/{{ $activities->id }}" enctype="multipart/form-data" style="background-color: #e9e9e9; color: black;" class="p-20">
                @csrf 
                @method('PUT') 
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-control w-full">
                        ...
                        <select class="select select-bordered w-full" name="category" value="{{ old('category') }}">
                    ...
                    <div class="form-control w-full">
                        ...
                        <input type="text"  class="input input-bordered w-full" name="description" value="{{ old('description') }}">
                        @error('description')
                            <div class="label">
                                <span class="label-text-alt text-error">{{ $message }}</span>
                            </div>
                    ...
                    <div class="form-control w-full">
                        ...
                        <input type="text" class="input input-bordered w-full" name="location" value="{{ old('location') }}">
                        @error('location')
                            <div class="label">
                                <span class="label-text-alt text-error">{{ $message }}</span>
                            </div>
                    ...
                    <div class="form-control w-full">
                        <label class="label">
                            <span class="label-text text-base-content">Location Link</span>
                        </label>
                        <input type="text" class="input input-bordered w-full" name="location_link" value="{{ old('location_link') }}">
                        @error('location_link')
                            <div class="label">
                                <span class="label-text-alt text-error">{{ $message }}</span>
                            </div>
                    ...
                    <div class="form-control w-full">
                        <label class="label">
                            <span class="label-text text-base-content">Activity Date</span>
                        </label>
                        <input type="date" class="input input-bordered w-full" name="activity_date" value="{{ old('activity_date') }}">
                        @error('activity_date')
                            <div class="label">
                                <span class="label-text-alt text-error">{{ $message }}</span>
                            </div>
                    ...
                    <div class="form-control w-full">
                        ...
                        <input type="file"  class="input input-bordered w-full p-2" name="image" value="{{ old('image') }}">
                        @error('image')
                            <div class="label">
                                <span class="label-text-alt text-error">{{ $message }}</span>
                            </div>
