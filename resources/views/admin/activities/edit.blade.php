...
@section('content')
    ...
    <div class="bg-white rounded-xl shadow dark:bg-slate-900 | max-w-6xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <form method="POST" action="{{ route('admin.activities.update', ['id' => $activities->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <!-- Card -->
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-16">
                <div class="space-y-2">
                    <label for="image" class="inline-block text-sm font-medium text-gray-800 mt-2.5 dark:text-gray-200">
                        Image
                    </label>
                    ...
                    <div class="space-y-4 sm:space-y-6">
                        ...
                        <div class="grid sm:grid-cols-2 gap-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <select id="category" name="category"
                                    ...
                                    <option >Pilih kateogri</option>
                                    <option {{ (($activities->category == "kesehatan" )? 'selected': '') }} value="kesehatan">Kesehatan</option>
                                    <option {{ (($activities->category == "olahraga" )? 'selected': '') }} value="olahraga">Olahraga</option>
                                </select>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="date" id="activity_date" name="activity_date"
                                    ...
                                    value="{{ $activities->activity_date }}"
                                    >
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <input id="location" type="text" name="location"
                                ...
                                placeholder="https://locationexample.com"
                        ...
                        <div class="space-y-2">
                            ...
                            <input id="location_link" type="text" name="location_link"
                                class="py-2 px-3 pe-11 block w-full border-2 border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                                placeholder="https://locationexample.com"
                                value="{{ $activities->location_link }}"
                                >
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea id="description" name="description"
                                class="py-2 px-3 block w-full border-2 border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                                rows="6" placeholder="Masukan deskripsi kegiatan">{{ $activities->description }}</textarea>
                        </div>
                    </div>
                    <!-- End Grid -->
