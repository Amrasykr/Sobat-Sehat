...
@section('content')
                        ...
                        <div
                            ...
                            <div class="sm:col-span-1">
                                <form action="{{ route('admin.news') }}" method="GET">
                                    <label for="hs-as-table-user-search" class="sr-only">Search</label>
                                    <div class="relative">
                                        <input 
                                            type="text" 
                                            id="hs-as-table-user-search"
                                            name="search"
                                ...
                                @foreach ($news as $new)
                                    <tr class="bg-white hover:bg-gray-50 dark:bg-slate-900 dark:hover:bg-slate-800">
                                            ...
                                            <div class="block p-6">
                                                <div class="flex items-center gap-x-4">
                                                    <div
                                                        ...
                                                        <img class=""
                                                            src="{{ asset("assets/img/news/$new->image") }}"
                                                            alt="">
                                                    </div>
                                                    <div>
                                                        <span
                                            ...
                                            <div class="block p-6">
                                                <div class="flex items-center gap-x-3">
                                                    ...
                                                    <div class="grow">
                                                        ...
                                                        <span
                                                            class="block text-sm text-gray-500">{{ $new->user->email }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="h-px w-px whitespace-nowrap align-top">
                                            <div class="block p-6">
                                                <span
                                                    class="text-sm text-gray-600 dark:text-gray-400">{{ \Carbon\Carbon::parse($new->created_at)->translatedFormat('l, j F Y') }}</span>
                                            </div>
                                        </td>
                                        {{-- news description --}}
                                        <td class="h-px w-px whitespace-nowrap align-top">
                                            <div class="block p-6">
                                                @if(strlen($new->description) > 15)
                                                    <div id="newsDescription{{$new->id}}" class="description">
                                                        <span class="text-sm text-gray-600 dark:text-gray-400 initial-text">
                                                            {{ substr($new->description, 0, 15) }}
                                                        </span>
                                                        <span id="moreText{{$new->id}}" class="hidden">{{ substr($new->description, 15) }}</span>
                                                        <a href="#" onclick="toggleDescription('newsDescription{{$new->id}}', 'moreText{{$new->id}}', 'moreLink{{$new->id}}')">...more</a>
                                                    </div>
                                                @else
                                                    <span class="text-sm text-gray-600 dark:text-gray-400">{{ $new->description }}</span>
                                                @endif
                                            </div>
                                        </td>
                                        {{-- action --}}
    ...
    <script>
        function toggleDescription(containerId, textId, linkId) {
            ...
            var moreLink = document.getElementById(linkId);

            if (moreText.style.display === 'none') {
                moreText.style.display = 'inline';
                moreLink.innerHTML = '...less';
                container.classList.remove('initial-text');
            } else {
                moreText.style.display = 'none';
                moreLink.innerHTML = '...more';
                container.classList.add('initial-text');
            }
        }
    </script>
  </body>
