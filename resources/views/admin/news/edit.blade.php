                    ...
                    <div class="space-y-4 sm:space-y-6">
                        ...
                        <div class="grid sm:grid-cols-2 gap-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <select id="category" name="category"
                                    ...
                                    <option {{ (($news->category == "kesehatan" )? 'selected': '') }} value="kesehatan">Kesehatan</option>
                                    <option {{ (($news->category == "olahraga" )? 'selected': '') }} value="olahraga">Olahraga</option>
                                </select>
                            </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea id="description" name="description"
                                class="py-2 px-3 block w-full border-2 border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                                rows="6" placeholder="Masukan deskripsi kegiatan">{{ $news->description }}</textarea>
                        </div>
                    </div>
                    <!-- End Grid -->
