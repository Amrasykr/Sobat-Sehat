...
<head>
    ...
    <style>
        ...
        .navbar {
            ...
            width: 100%;
            z-index: 999;
            /* Menentukan stacking order agar header tetap di atas konten lainnya */
        ...
        .content {
            ...
            padding-top: 80px;
            /* Misalnya, jika tinggi header adalah 80px */
            /* Tambahkan gaya CSS lain yang diperlukan */
        }
    </style>
...
<body>
    ...
    <div class="bg-cover bg-center" style="background-image: url('/img/landingpage-bg.svg')">
        ...
        <div class="navbar bg-base-100 flex justify-between items-center px-14 py-4 shadow-lg"
                    ...
                    <ul class="menu menu-horizontal px-9">
                        <li>
                            <a class="text-base font-semibold" style="color: #2BA6CC;"
                                onmouseover="this.style.color='#11B621'" onmouseout="this.style.color='#2BA6CC'"
                                href="{{ url('/') }}">Beranda
                            </a>
                        </li>
                        <li>
            ...
            <div class="flex gap-2 items-center">
                <div class="flex items-center pr-4"> <!-- Bagian pencarian -->
                    <div class="form-control flex items-center  relative rounded-full">
                        ...
                        <input type="text" placeholder="Cari Kegiatan!" class="input input-bordered w-90 md:w-96"
                ...
                <div class="dropdown dropdown-end">
                    ...
                    <ul tabindex="0"
                        ...
                        @if (auth()->check())
                            <li>
                                <a style="color: #2BA6CC;" href="{{ route('admin.dashboard') }}"
                                    onmouseover="this.style.color='#11B621'"
                                    onmouseout="this.style.color='#2BA6CC'">Dashboard</a>
                            </li>
        ...
        <footer class="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300"
            ...
            <aside class="items-center grid-flow-col">
                <img src="/img/sobatsehat-vertical.svg" alt="Logo Sobat Sehat" class="h-20">
                <p>Sobat Sehat<br />Providing reliable tech since 2023</p>
            </aside>
