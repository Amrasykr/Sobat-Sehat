        ...
        <div class="hero min-h-screen" >
          ...
          <div class="flex flex-wrap justify-center gap-4 py-10">
            ...
            @foreach ($activities as $activity)
              <a href="/user/activities/show/{{ $activity->id }}">
                  <div class="card w-96 bg-base-100 shadow-xl">
                    <figure class="p-2">
                      <img src="{{ asset('assets/img/activities/' . $activity->image) }}" 
                          alt="Shoes" 
                    ...
                    <div class="card-body">
                      ...
                      <div class="card-actions justify-end">
                        <div class="badge badge-outline">{{ \Carbon\Carbon::parse($activity->activiy_date)->translatedFormat('l, j F Y') }}</div> 
